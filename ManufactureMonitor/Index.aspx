                ...
                <table style="border: 3px solid #CC6666; width: 938px; border-collapse: collapse; margin-left: 167px; margin-top: 0em; height: 426px;">
                    ...
                    <tr>
                        <td style="background-color: #FFCC66; width: 434px; height: 89px; text-align: center">
                            <div id="Div1" onmouseover="Dark('Div1')" onmouseout="Light('Div1')" 
                                style="position: absolute; width: 182px; height: 45px; margin-left: 3px; top: 218px; left: 265px;">
                                <asp:Button ID="Button1" runat="server" BackColor="#FF9966" BorderColor="#CC6666" BorderStyle="Solid" BorderWidth="3px" 
                                    Text="Che" Width="182px" Font-Names="Arial" Height="45px" Style="margin-top: 0px" OnClick="Button1_Click" />
                            </div>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </td>
                        <td style="background-color: #FFCC66; width: 243px; height: 89px; text-align: center">
                            <div id="Div2" onmouseover="Dark('Div2')" onmouseout="Light('Div2')" 
                                style="position: absolute; width: 182px; height: 45px; margin-left: 3px; top: 218px; left: 492px;">
                                <asp:Button ID="Button2" runat="server" BackColor="#FF9966" BorderColor="#CC6666" BorderStyle="Solid" BorderWidth="3px" 
                                    Text="TubeFinal" Width="182px" Font-Names="Arial" Height="45px" Style="margin-top: 0px; margin-left: 0px;" OnClick="Button2_Click" />
                            </div>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </td>
                    ...
                    <tr>
                        <td style="background-color: #FFCC66; text-align: center; height: 48px; width: 434px;">
                            <div id="Div4" onmouseover="Dark('Div4')" onmouseout="Light('Div4')" 
                                style="position: absolute; width: 182px; height: 45px; margin-left: 3px; top: 271px; left: 262px; margin-top: 0px;">
                                <asp:Button ID="Button3" runat="server" BackColor="#FF9966" BorderColor="#CC6666" BorderStyle="Solid" BorderWidth="3px" 
                                    Text="AirCleaner" Width="182px" Font-Names="Arial" Height="45px" Style="margin-top: 0px" OnClick="Button3_Click" />
                            </div>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                     
                        </td>
                        <td style="background-color: #FFCC66; text-align: center; height: 48px; width: 243px;">
                            <div id="Div6" onmouseover="Dark('Div6')" onmouseout="Light('Div6')" 
                                style="position:absolute; width: 182px; height: 45px; margin-left: 3px; top: 271px; left: 492px; margin-top: 0px;">
                                <asp:Button ID="Button6" runat="server" BackColor="#FF9966" BorderColor="#CC6666" BorderStyle="Solid" BorderWidth="3px" 
                                    Text="Group 1" Width="182px" Font-Names="Arial" Height="45px" Style="margin-top: 0px" OnClick="Button6_Click" />
                            </div>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                        </td>
