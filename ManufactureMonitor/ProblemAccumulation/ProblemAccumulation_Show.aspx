    ...
    <table style="width: 100%; border-collapse: collapse">
        ...
        <tr>
            <td style="height: 23px; text-align: center">
                ...
                <asp:GridView ID="GridView1" runat="server" HorizontalAlign="Left" CellPadding="3" BackColor="#DEBA84" BorderColor="#996633" BorderStyle="Solid" BorderWidth="1px" CellSpacing="2" ShowHeaderWhenEmpty="True" Width="339px" style="margin-left: 487px">
