...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <table style="width: 100%; border-collapse: collapse">
        ...
        <tr>
            ...
            <td style="background-color: #99CCFF; height: 30px; width: 48px;"></td>
        ...
        <tr>
            ...
            <td style="background-color: #99CCFF; height: 30px; width: 48px;">
        ...
        <tr>
            ...
            <td style="height: 30px; background-color: #99CCFF; width: 48px;">
        ...
        <tr>
            <td style="text-align: center; width: 200px; height: 30px;"></td>
            <td style="background-color: #99CCFF; text-align: left; width: 266px; height: 30px;"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; CIGMA Code:</strong></td>
            <td style="background-color: #99CCFF; height: 30px; width: 48px;">
                <asp:TextBox ID="TextBox3" runat="server" Width="584px"></asp:TextBox>
                &nbsp;
            </td>
            <td style="background-color: #FFFFCC; height: 30px;"></td>
        </tr>
