    ...
    <table style="width: 100%; border-collapse: collapse">
        <tr>
            <td style="height: 51px; text-align: center">
                &nbsp;
                <asp:TextBox ID="TextBox1" runat="server" BorderColor="Gray" BorderStyle="Solid" BorderWidth="3px" Font-Bold="True" Width="534px" Height="30px" style="font-size: large; margin-left: 300px;">                                       Project Definition</asp:TextBox>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <tr>
            <td>
                <table style="border: thin solid #FFAF37; width: 23%; border-collapse: collapse; height: 315px; margin-left: 470px; background-color: #FFFFCC; ">
                    <tr>
                    ...
                    <tr>
                        <td style="text-align: center; width: 114px;" rowspan="3">
                <asp:ListBox ID="ProjectSelectionListBox" runat="server" SelectionMode="Single" Height="150px" Width="175px" />
                        </td>
