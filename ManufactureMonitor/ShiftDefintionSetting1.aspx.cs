    ...
    public partial class ShiftDefintionSetting1 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
           // Session["Id"] = dt.Rows[MachineSelectionListBox.SelectedIndex]["Id"];
            Response.Redirect("~/ShiftDefinitionSetting.aspx?MachineId=" + dt.Rows[MachineSelectionListBox.SelectedIndex]["Id"] + "&MachineGroupId=" + Request.QueryString["MachineGroupId"]);
        }
