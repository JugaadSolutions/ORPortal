<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DisplayShiftDefinition1.aspx.cs" Inherits="ManufactureMonitor.Shifts.DisplayShiftDefinition1" %>
    ...
    <table style="width: 1500px; border-collapse: collapse; background-color: #FFFFCC; height: 450px">
        <tr>
            <td style="height: 46px; text-align: center;">
                <asp:TextBox ID="TextBox1" runat="server" BorderColor="Gray" BorderStyle="Solid" BorderWidth="3px" Font-Bold="True" Width="507px" Height="30px" style="font-size: large">                                  Display Shift Definition</asp:TextBox>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
