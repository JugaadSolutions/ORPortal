...
namespace ManufactureMonitor.Shifts
{
    public partial class DisplayShiftDefinition1 : System.Web.UI.Page
    {
        static DataTable dt;
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/Shifts/DisplayShiftDefinition.aspx?MachineId=" + dt.Rows[MachineSelectionListBox.SelectedIndex]["Id"]
