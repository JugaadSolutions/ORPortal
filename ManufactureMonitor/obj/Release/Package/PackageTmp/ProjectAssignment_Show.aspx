...
&nbsp;<asp:ImageButton ID="ImageButton1" runat="server" Height="25px" ImageAlign="Middle" ImageUrl="~/Images/return.jpg" Width="25px" OnClick="ImageButton1_Click" />
        ...
        <tr>
            ...
            <td style="background-color: #99CCFF; text-align: center; width: 450px;">
                <table style="border: thin solid #3366FF; width: 100%; border-collapse: collapse">
                    ...
                    <tr>
                        <td style="width: 194px">Date:</td>
                        <td>Shifts:</td>
                    </tr>
                    <tr>
                        <td style="width: 194px">
                            <asp:Calendar ID="Calendar1" runat="server" BackColor="White" BorderColor="#3366CC" BorderWidth="1px" CellPadding="1" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="#003399" Height="135px" Width="160px" style="margin-left:15px">
                    ...
                    <tr>
                        <td colspan="2" style="height: 40px">
                            <asp:Button ID="Button3" runat="server" Text="Machine OFF retroactively" Width="256px" />
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" style="height: 40px">
                            <asp:Button ID="Button4" runat="server" Text="Cancel Machine OFF Immediately" Width="256px" />
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">&nbsp;</td>
        ...
        <tr>
            <td style="height: 30px; width: 396px;"></td>
